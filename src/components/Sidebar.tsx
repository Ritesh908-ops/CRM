  ...
  return (
    <>
      ...
      <aside className={`sb ${isMobileMenuOpen ? 'open' : ''}`}>
        {/* Brand Header */}
        <div className="sb-brand" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', height: '64px', padding: '8px 14px', borderBottom: '0.5px solid rgba(60,60,67,0.12)' }}>
          <div style={{ display: 'flex', alignItems: 'center', flex: 1, minWidth: 0, height: '100%' }}>
            <img src="/logo.png" alt="Khataview CRM" style={{ height: '48px', objectFit: 'contain' }} />
          </div>
