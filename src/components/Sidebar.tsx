  ...
  return (
    <>
      ...
      <aside className={`sb ${isMobileMenuOpen ? 'open' : ''}`}>
        {/* Brand Header */}
        <div className="sb-brand" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', padding: '12px 16px', borderBottom: '0.5px solid rgba(60,60,67,0.12)' }}>
